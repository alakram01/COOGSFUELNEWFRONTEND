    ...
    <div>
      ...
      <div className="container mt-4 center" >
        <form id="clientForm ">
          ...
          <input onChange={this.onFullNameChange} type="text" id="fullName" name="fullName" maxLength="50" value={name} required />
          {errors.fullname && <p className="error">{errors.fullname}</p>}{" "}
                {/* Display email error */}    
          <label htmlFor="address1">Address 1:</label>
          <input onChange={this.onAddress1Change} type="text" id="address1" name="address1" maxLength="100" value={this.address1} required />
